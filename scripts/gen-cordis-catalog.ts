...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  lsp: 'lsp.md',
  marketNews: 'market-snapshot.md',
  marketSnapshots: 'market-snapshot.md',
  marketTacticHistory: 'market-tactic-lab.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  MarketNewsAcquireInput: 'market-snapshot.md',
  MarketNewsBatch: 'market-snapshot.md',
  MarketSnapshot: 'market-snapshot.md',
  MarketSnapshotAdapter: 'market-snapshot.md',
  MarketSnapshotDiscoveryRequest: 'market-snapshot.md',
  MarketSnapshotIdentityInput: 'market-snapshot.md',
  MarketSnapshotSummary: 'market-snapshot.md',
  TacticLabHistoryAdapter: 'market-tactic-lab.md',
  TacticLabHistoryChunk: 'market-tactic-lab.md',
  TacticLabHistoryRequest: 'market-tactic-lab.md',
