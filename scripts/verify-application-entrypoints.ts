...
const EXECUTABLE_SOURCE_ALLOWLIST = new Map<string, string>([
  ...
  ['packages/market/tool-maoq-snapshot/tests/fixtures/loader/driver.ts', 'test-only subprocess driver'],
  ['packages/market/tool-maoq-tactic-research/tests/fixtures/loader/driver.ts', 'test-only subprocess driver'],
  ...
  ['packages/workflow/tool-maoq-decision/tests/fixtures/loader/driver.ts', 'test-only subprocess driver'],
