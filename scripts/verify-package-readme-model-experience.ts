...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  'packages/market/market-snapshot': { kind: 'none', reason: 'The host-side fact store registers no model-visible context or tool.' },
  'packages/market/market-snapshot-json': { kind: 'none', reason: 'The host-side import adapter registers no model-visible context or tool.' },
  ...
  'packages/market/market-tactic-routing': { kind: 'indirect', reason: 'Model-facing P2 consumers own presentation of the deterministic route; the library invokes no model.' },
  ...
  'packages/client/ui-brand-maoq': { kind: 'none', reason: 'Browser-side presentation occupants; registers nothing model-facing.' },
