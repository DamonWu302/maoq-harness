...
export const PUBLIC_TACTIC_EVIDENCE: readonly PublicTacticEvidence[] = deepFreeze([
  ...
  {
    evidenceId: 'china-correlation-consolidated-industry-momentum-2022',
    tacticId: 'correlation_cluster_sector_rotation',
    tier: 'peer-reviewed',
    decisionUse: 'architecture-benchmark',
    title: 'Industry momentum with correlation consolidation: evidence from China',
    sourceUrl: 'https://doi.org/10.1057/s41260-021-00248-8',
    sample: 'Shanghai and Shenzhen A-shares, June 2007 through December 2020',
    portfolioAndFrequency: 'monthly long-short consolidated-industry momentum',
    reportedAnnualizedSharpe: 1.16,
    reportedMaximumDrawdown: null,
    relevance: 'Supports grouping co-moving industries before ranking persistent sector leadership.',
    limitations: [
      'The reported optimum correlation threshold and long-short portfolio are not MAOQ promotion evidence.',
      'The MAOQ trial uses weekly close-known clustering and next-open long-only stock mapping.',
    ],
  },
  {
    evidenceId: 'china-residual-momentum-frl-2019',
    tacticId: 'sector_residual_strength',
    tier: 'peer-reviewed',
    decisionUse: 'hypothesis',
    title: 'Residual momentum and the cross-section of stock returns: Chinese evidence',
    sourceUrl: 'https://doi.org/10.1016/j.frl.2018.12.014',
    sample: 'Shanghai and Shenzhen A-shares, July 1997 through December 2017',
    portfolioAndFrequency: 'monthly winner-minus-loser residual-momentum portfolios',
    reportedAnnualizedSharpe: null,
    reportedMaximumDrawdown: null,
    relevance: 'Supports ranking idiosyncratic continuation after removing common return exposure.',
    limitations: [
      'The reported 10.584% annual return is a long-short spread, not a long-only portfolio return.',
      'MAOQ uses sector-relative daily returns rather than the paper factor-model residual.',
    ],
  },
  {
    evidenceId: 'china-volatility-effect-2021',
    tacticId: 'low_volatility_sector_leader',
    tier: 'peer-reviewed',
    decisionUse: 'architecture-benchmark',
    title: 'The Volatility Effect in China',
    sourceUrl: 'https://doi.org/10.1057/s41260-021-00218-0',
    sample: 'Investable China A-shares, December 2000 through December 2018',
    portfolioAndFrequency: 'monthly value-weighted low-risk factor portfolio',
    reportedAnnualizedSharpe: 0.88,
    reportedMaximumDrawdown: null,
    relevance: 'Supports preferring lower realized risk over raw price momentum in non-acceleration states.',
    limitations: [
      'The published factor includes a short high-volatility leg and is not a sector-gated stock strategy.',
      'The MAOQ trial uses daily price-only volatility and next-open long-only execution.',
    ],
  },
])
