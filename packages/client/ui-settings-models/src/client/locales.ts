...
export const en = {
  ...
  defaultModelTitle: 'Commander model',
  defaultModelDescription: 'Choose the model source and exact model used when a new task starts.',
  defaultModelNewTasks: 'New tasks',
  defaultModelSource: 'Model source',
  sourceCodex: 'Local Codex login',
  sourceCodexDescription: 'Use your existing ChatGPT/Codex sign-in. No additional API key is required.',
  sourceExternal: 'External API',
  sourceExternalDescription: 'Keep using a provider configured with an API key or environment authentication.',
  defaultProvider: 'Provider',
  defaultModel: 'Model',
  defaultModelPlaceholder: 'Enter the provider model ID',
  defaultModelHint: 'The current task keeps its model. This selection applies when the next task is created.',
  defaultModelApply: 'Use this model',
  defaultModelSaving: 'Switching…',
  defaultModelSaved: 'Default commander model updated.',
  codexUnavailable: 'The local Codex route is not enabled in this profile.',
  edit: 'Edit',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  defaultModelTitle: '统帅模型',
  defaultModelDescription: '选择新任务启动时使用的模型来源与具体模型。',
  defaultModelNewTasks: '新任务生效',
  defaultModelSource: '模型来源',
  sourceCodex: '本机 Codex 登录',
  sourceCodexDescription: '复用当前 ChatGPT / Codex 登录，无需另配 API Key。',
  sourceExternal: '外部模型 API',
  sourceExternalDescription: '继续使用已配置 API Key 或环境认证的模型提供方。',
  defaultProvider: '模型提供方',
  defaultModel: '指定模型',
  defaultModelPlaceholder: '输入提供方的模型 ID',
  defaultModelHint: '当前任务不会中途换模；该选择从下一个新任务开始生效。',
  defaultModelApply: '切换到该模型',
  defaultModelSaving: '切换中…',
  defaultModelSaved: '统帅默认模型已更新。',
  codexUnavailable: '当前 Profile 尚未启用本机 Codex 通道。',
  edit: '编辑',
