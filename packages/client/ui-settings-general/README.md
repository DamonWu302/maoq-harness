...
The Host half retains the `ui-onboarding` user-settings namespace for compatibility with existing settings documents. No current onboarding step reads or writes its legacy `welcomeNoticeVersion`; the shell remains policy-free.
