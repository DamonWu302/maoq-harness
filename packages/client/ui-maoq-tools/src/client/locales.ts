...
export const zh = {
  ...
  'tacticSources.title': '查看战法与回测数据源',
  'tacticBacktest.title': '运行战法历史回测',
  'row.running': '正在执行',
  'row.failed': '执行失败',
  'row.stopped': '执行已中止',
  'row.result': '结构化结果',
...
export const en = {
  ...
  'tacticSources.title': 'Browse tactics and backtest sources',
  'tacticBacktest.title': 'Run tactic history backtest',
  'row.running': 'Running',
  'row.failed': 'Failed',
  'row.stopped': 'Stopped',
