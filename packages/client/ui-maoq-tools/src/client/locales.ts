...
export const zh = {
  ...
  'stateRefreshDaily.title': '生成每日标准战略状态',
  'row.running': '正在执行',
  'row.failed': '执行失败',
  'row.stopped': '执行已中止',
  'row.result': '结构化结果',
  ...
  'state.dailyWindow': '自动选取最近 3 个交易日',
  'settings.nav': 'MAOQ',
  'settings.title': '研判引擎',
...
export const en = {
  ...
  'stateRefreshDaily.title': 'Generate canonical daily strategy state',
  'row.running': 'Running',
  'row.failed': 'Failed',
  'row.stopped': 'Stopped',
  ...
  'state.dailyWindow': 'Auto-select latest 3 trading days',
  'settings.nav': 'MAOQ',
