...
- **Daily generation is manual or externally scheduled** — the canonical tool is idempotent, but this package does not yet start its own post-close or event-driven scheduler.
