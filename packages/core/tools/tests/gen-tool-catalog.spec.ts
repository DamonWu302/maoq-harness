...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'maoq_analyze_strategy', 'maoq_decide', 'maoq_select_tactics', 'maoq_snapshot_generate',
      'maoq_snapshot_inspect', 'maoq_snapshot_list', 'maoq_snapshot_sources', 'maoq_state_get',
      'maoq_state_history', 'maoq_state_latest', 'maoq_state_refresh_daily', 'maoq_tactic_backtest',
      'maoq_tactic_research_sources', 'pwsh', 'pwsh', 'ralph',
