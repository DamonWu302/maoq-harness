...
Source: [`packages/workflow/tool-maoq-decision/src/index.ts:48`](../packages/workflow/tool-maoq-decision/src/index.ts)
...
Source: [`packages/market/tool-maoq-tactic-research/src/index.ts:27`](../packages/market/tool-maoq-tactic-research/src/index.ts)
